...
import {DayOffType, DayOffleaveType} from '~/constants/types';
...
export default function CreateDayOff() {
    ...
    const calculateDistance = (startDate: Date, endDate: Date, holidaysDate: Date[]): number => {
        ...
        const filteredHolidays = holidaysDate.filter((h: Date) => dayjs(h).isBetween(dayjs(startDate), dayjs(endDate), 'days', '[]'));

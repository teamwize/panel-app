...
import {TeamCreateRequest, TeamResponse} from "~/constants/types";
...
export default function UpdateTeam() {
    ...
    const editTeam = (data: UpdateTeamInputs) => {
        let payload: TeamCreateRequest = {
            name: data.name,
            metadata: {},
        }
        ...
        <div className='md:w-4/5 w-full overflow-y-auto mb-2 fixed top-16 md:top-0 bottom-0 right-0 h-screen'>
            <div className='pt-5 py-4 md:mx-auto md:w-full md:max-w-[70%]'>
                <div className="flex items-center border-b border-gray-200 dark:border-gray-800 pb-4 mb-4">
                    ...
                    <h1 className="text-lg md:text-xl font-semibold text-indigo-900 dark:text-indigo-200">Update
                        Team</h1>
                </div>
                ...
                <form className="space-y-4 px-4" onSubmit={handleSubmit(onSubmit)}>
                        ...
                        <div className="mt-2">
                            <input {...register("name", {
                                ...
                                minLength: {value: 2, message: "Team Name must be over 2 characters"}
                                   ...
                                   aria-invalid={errors.name ? "true" : "false"} name="team" type="text"
                                   defaultValue={name}
                    ...
                    <Button type='submit' isProcessing={isProcessing} text='Change'

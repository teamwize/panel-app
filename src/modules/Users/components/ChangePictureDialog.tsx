import {AssetResponse, UserUpdateRequest} from "@/constants/types/userTypes.ts";
import AvatarEditor from "react-avatar-editor";
import React, {useState} from "react";
import {dataURLtoFile} from "@/lib/utils.ts";
import {createAssets, updateUser} from "@/services/userService.ts";
...
export function ChangePictureDialog({initialImageUrl,  onChange}: ChangePictureDialogProps) {

    ...
    <div className='md:w-4/5 overflow-y-auto w-full fixed mb-2 top-16 md:top-0 bottom-0 right-0 h-screen'>
      <div className='pt-5 py-4 md:mx-auto md:w-full md:max-w-[70%]'>
        <div className="flex items-center border-b border-gray-200 dark:border-gray-800 pb-4 mb-4">
          ...
          <h1 className="text-lg md:text-xl font-semibold text-indigo-900 dark:text-indigo-200">Change Password</h1>
        </div>
        ...
        <form className="space-y-4 px-4" onSubmit={handleSubmit(onSubmit)}>
          <div>
            <label htmlFor="password" className="block text-sm leading-6">Current Password</label>
            <div className="mt-2">
          ...
          <div>
            <label htmlFor="newPassword" className="block text-sm leading-6">New Password</label>
            <div className="mt-2">
          ...
          <div>
            <label htmlFor="reNewPassword" className="block text-sm leading-6">Re-type New Password</label>
            <div className="mt-2">

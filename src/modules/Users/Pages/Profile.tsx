...
import {Toolbar, Button, Alert} from '../../../core/components'
            ...
            <div className='pt-5 py-4 md:mx-auto md:w-full md:max-w-[70%]'>
                <Toolbar title='Profile'>
                    <button onClick={() => setLogOut(true)}
                            className='flex items-center w-full rounded-md bg-red-700 text-white p-2 text-sm font-semibold shadow-sm hover:bg-red-500 focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-red-800'>
                        <ArrowLeftEndOnRectangleIcon
                            className='w-5 h-5 text-gray-400 mr-2'></ArrowLeftEndOnRectangleIcon>
                        Log Out
                    </button>
                </Toolbar>
                                    ...
                                    <div className="mt-2">
                                        <input {...register("firstName", {
                                            ...
                                            minLength: {value: 2, message: "First Name must be over 2 characters"}
                                               ...
                                               aria-invalid={errors.firstName ? "true" : "false"} name="firstName"
                                               type="text"
                                    ...
                                    <div className="mt-2">
                                        <input {...register("lastName", {
                                            ...
                                            minLength: {value: 2, message: "Last Name must be over 2 characters"}
                                               ...
                                               aria-invalid={errors.lastName ? "true" : "false"} name="lastName"
                                               type="text"
                ...
                <div className="flex min-h-full items-center justify-center p-4 text-center">
                    <Dialog.Panel
                        ...
                        <div className='flex items-center mb-6'>
                            <ArrowLeftEndOnRectangleIcon
                                className='w-5 h-5 mr-2 cursor-pointer text-red-600'></ArrowLeftEndOnRectangleIcon>
                        ...
                        <section className='flex text-center justify-center'>
                            ...
                            <button onClick={() => handleRequest(true)}
                                    className='rounded-lg p-2 shadow-md ml-4 bg-red-600 text-indigo-100 w-1/2'>Yes
                            </button>
                        </section>
                    </Dialog.Panel>
                </div>
            ...
            <div className='fixed inset-0 overflow-y-auto top-[-22px] bg-[#1111118c] z-50'>
                <div className="flex min-h-full items-center justify-center p-4 text-center">
                    <Dialog.Panel
                        ...
                        <AvatarEditor ref={setEditorRef} image={picture.img} width={200} height={200} border={20}
                                      color={[255, 255, 255, 0.6]} className='right-0 left-0 mx-auto' rotate={0}
                                      scale={picture.zoom}/>

                        <Slider aria-label="raceSlider" value={picture.zoom} min={1} max={10} step={0.1}
                                onChange={handleSlider}></Slider>

                        <section className='flex text-center justify-center'>
                            <button onClick={handleCancel}
                                    className='rounded-lg p-2 shadow-md border border-indigo-600 w-1/2'>Cancel
                            </button>
                            <button onClick={handleSave}
                                    className='rounded-lg p-2 shadow-md ml-4 bg-indigo-600 w-1/2'>Save
                            </button>
                        </section>
                    </Dialog.Panel>
                </div>

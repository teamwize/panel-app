...
import {LeaveTypeCycle, LeaveTypeCycleJson} from "@/constants/types/enums.ts";
...
export function UpdateLeaveType({ leaveType, handleUpdate, handleClose }: UpdateDialogProps) {

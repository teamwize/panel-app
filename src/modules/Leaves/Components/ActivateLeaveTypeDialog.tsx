...
import { LeaveTypeSchema } from "@/modules/Leaves/Pages/UpdateLeavePolicy.tsx";
...
export default function ActivateLeaveTypeDialog({isOpen, onClose, leaveTypes, onSave, schema, defaultValues,}: ActivateLeaveTypeDialogProps) {

...
import { LeaveTypeCycle } from "@/constants/types/enums";
import { LeaveTypeCreateRequest } from "@/constants/types/leaveTypes.ts";
...
export function CreateLeaveType({ isOpen, onClose, onSubmit }: LeaveTypeCreateModalProps) {

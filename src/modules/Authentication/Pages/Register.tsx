        ...
        <>
            <div className="flex flex-col justify-center p-4 lg:px-8 w-full">
                <div className="md:mx-auto md:w-full md:max-w-5xl">
                    ...
                    <p className="my-4 text-center text-xl md:text-2xl font-semibold tracking-tight text-indigo-600">Welcome
                        to Teamwize</p>
                </div>
                ...
                <div className="mt-4 sm:mx-auto sm:w-full sm:max-w-md">
                    <div
                        ...
                        <form className="space-y-4" onSubmit={handleSubmit(onSubmit)}>
                            <div>
                                <label htmlFor="organization-name" className="block text-sm leading-6">Organization
                                    Name</label>
                                <div className="mt-2">
                                    <input {...register("organization", {
                                        ...
                                        maxLength: {
                                            value: 20,
                                            message: "Organization name must be under 20 characters"
                                        },
                                        minLength: {value: 2, message: "Organization name must be over 2 characters"}
                                    })}
                                           aria-invalid={errors.organization ? "true" : "false"} name="organization"
                                           type="text"
                            ...
                            <div>
                                <label htmlFor="Country" className="block text-sm leading-6 mb-2">Country</label>
                                <select {...register("country", {required: "Country is required"})}
                                        aria-invalid={errors.country ? "true" : "false"} name="country"
